public class StringYazici {
    ...
    public final static String genelMenuUrunEklemeYazisi = " 0- Ürün ve personel ekle";
    ...
    public final static String duzCizgiYazisi = "-----------------------------------------------------------------------";
    public final static String tabYazisi = "\t";
    public final static String altSatirYazicisi = "\n";


    //ÜRÜN EKLEME MENUSU STRİNGLERİ
    public final static String secimYazisi = "Lütfen sebze ve meyve eklemek için seçim yapınız";
    public final static String sebzeYazisi = "0 - Sebze";
    ...
    public final static String urunAdiniGirinizYazisi ="Lütfen ürün adini giriniz";
    public final static String urunAdediGirinizYazisi = "Lütfen ürün adedi giriniz";
    public final static String personelAdiGirinizYazisi = "Lütfen personel adi giriniz";


    //SATTIS MENUSU STRİNGLERİ
    public final static String satısMenusuUrunKodu =  "Lütfen satış yapmak istediğiniz ürünün kodunu giriniz";
    public final static String musterininKacAdetIstedigiYazisi = "Satın almak istenilen miktari giriniz";
